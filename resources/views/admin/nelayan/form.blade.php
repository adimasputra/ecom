<div class="row">
    ...
    <form method="post" enctype="multipart/form-data" id="form" action="{{route('nelayan.store')}}">
        ...
        <div class="form-group form-password">
            ...
            <input type="password" class="form-control input-value" id="Password" name="password" required>
        </div>
        <br>
        <br>
        <b>Data Tambak</b>
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control input-value foto" id="Foto" accept="image/x-png,image/gif,image/jpeg" name="foto" required>
        </div>
        <div class="form-group">
